...
struct InstructionsResidents: View {
            ...
            VStack(){
                ...
                ZStack(alignment: Alignment(horizontal: .center, vertical: .top), content: {
                    ...
                    VStack{
                        ...
                        HStack{
                        LottieView(name: "cash", loopMode: .loop)
                            ...
                            VStack(alignment: .leading, spacing: 10, content: {
                                ...
                                Text("Reduce your rent and earn cash for showing off your community to your peers!")
                        ...
                        HStack{
                            ...
                            VStack(alignment: .leading, spacing: 10, content: {
                                ...
                                Text("Celebrate and enjoy the benefits of your building with your new neighbors.")
                                    .frame(width: 180, alignment: .trailing)
                                    .foregroundColor(Color("Instructions_Color"))
                                    .multilineTextAlignment(.leading)
                                    .padding(.horizontal, 30)
                            ...
                            LottieView(name: "friends", loopMode: .loop)
                                        .frame(width: 200, height: 200)
                        }
